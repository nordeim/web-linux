 ...
 */
async function waitForContainer(container, timeoutMs = 5000) {
...
function spawnAttachment(containerName, onData) {
...
export async function spawnContainerShell(sessionId, onData) {
